...
% 匈牙利算法
p.costCand = 0.2;                    % 候选区-点云簇关联cost阈值
p.costConfirm = 0.2;                % 确立区-点云簇关联cost阈值
