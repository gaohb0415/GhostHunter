...
binFilePath = 'G:\radarData\23.11.20\empty\48chn\10s\1';
...
cfarParamRA.train = [12, 6]; % 单边 [距离,  角度] [12, 6]
cfarParamRA.guard = [8, 4]; % 单边 [距离,  角度] [8, 4]
cfarParamRA.pfa = 0.01; % 0.01
cfarParamRA.extraTh = 3e3; % 3.5e3
