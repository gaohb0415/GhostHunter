...
cascade_mode_list = {0, 2, 2, 2} -- 0: Single chip, 1: Master, 2: Slave

-- F/W Download Path
metaImagePath = "D:\\Softwares\\ti\\mmwave_dfp_02_02_03_01\\firmware\\xwr22xx_metaImage.bin"
...
local end_chirp_tx = 0 -- lhk
local nchirp_loops = 199 -- Number of chirps per frame
local nframes_master = 65 -- Number of Frames for Master
local Inter_Frame_Interval = 1000 -- ms
...
if (0 == ar1.ChanNAdcConfig_mult(1, 1, 0, 0, 0, 0, 0, 1, 2, 1, 0, 0)) then
